      ...
      <div style={{ backgroundColor: "#020617" }}>
        ...
        >
          ...
          <div className="justify-between px-4 mx-auto lg:max-w-7xl md:items-center md:flex md:px-36">
              ...
              <div className="flex  items-center justify-between py-3 md:py-2 md:block">
                ...
                {router.pathname !== "/auth/login" &&
                  router.pathname !== "/dashboard" && (
                    <div
                      className={`cart relative inline-block mr-2 md:absolute md:right-0 right-8 ${
            ...
            <div className="md:absolute lg:absolute xl:absolute md:top-5 xl:top-5 lg:top-5 md:right-36 mt-2 md:mt-0 ">
              {/* Conditionally render the SearchBox on the /products page */}
              {router.pathname === "/" && (
                <div className="">
          ...
          {router.pathname === "/products" && (
            <div className="md:px-32 w-full bg-yellow-400 top-0 left-0 right-0 z-10 text-black md:h-14 h-12 md:visible">
              <ul className="flex md:flex-row md:justify-between gap-20 xxs:gap-24 xxss:gap-28 xs:gap-20 md:items-center md:mr-24">
                <li className="xl:text-sm lg:text-sm xs:text-xs xxs:text-xs xxss:text-xs text-gray-900 py-2 px-4 text-center  border-b-2 md:border-b-0  hover:bg-yellow-400  border-yellow-400  md:hover:text-yellow-400 md:hover:bg-transparent">
                          ...
                          <div className="p-4 text-white md:mt-0">
                            <ul className=" md:flex flex-row md:justify-between md:px-16">
                              <li
                                ...
                                className="xl:text-sm lg:text-sm xs:text-xs xxs:text-xs xxss:text-xs cursor-pointer text-white py-2 md:px-4 text-center md:hover:text-yellow-400 hover:bg-yellow-400 md:hover:bg-transparent"
                              >
                                <p>Rosmalai</p>
                              </li>
                              <li
                                onClick={() => handleNavigation("Doremon")}
                                className="xl:text-sm lg:text-sm xs:text-xs xxs:text-xs xxss:text-xs cursor-pointer text-white py-2 px-4 text-center md:hover:text-yellow-400 hover:bg-yellow-400 md:hover:bg-transparent"
                              >
                                <p>Doremon</p>
                              </li>
                              <li
                          ...
                          <div className="p-4 text-white md:mt-0">
                            <ul className=" md:flex flex-row md:justify-between md:px-16">
                              <li
                                ...
                                className="cursor-pointer xl:text-sm lg:text-sm xs:text-xs xxs:text-xs xxss:text-xs text-white py-2 md:px-4 text-center md:hover:text-yellow-400 hover:bg-yellow-400 md:hover:bg-transparent"
                              >
                                <p>Vanilla </p>
                              </li>
                              <li
                                onClick={() => handleNavigation("Mango")}
                                className="cursor-pointer xl:text-sm lg:text-sm xs:text-xs xxs:text-xs xxss:text-xs text-white py-2 px-4 text-center md:hover:text-yellow-400 hover:bg-yellow-400 md:hover:bg-transparent"
                              >
                                <p>Mango</p>
                              </li>
                              <li
