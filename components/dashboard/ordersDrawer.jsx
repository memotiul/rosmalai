...
const Drawer = () => {
  ...
  const menuItems = [
    { label: "View Orders", path: "/dashboard?component=orders" },
    { label: "View Customers", path: "/dashboard?component=viewCustomers" },
  ];
  ...
  return (
    <div>
      ...
      >
        ...
        <p className="mt-1"> View Orders</p>
        {isOpen ? (
          ...
          <nav>
            <ul>
              {menuItems.map((item) => (
                ...
                >
                  <Link href={item.path}>
                    <div className="flex flex-row gap-1 px-4 py-2 hover:bg-gray hover:text-white-800 mb-1 rounded">
                      <IoIosEye
